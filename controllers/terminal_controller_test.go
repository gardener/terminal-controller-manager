...
var _ = Describe("Terminal Controller", func() {
	...
	Context("Terminal deletion when referenced resources are missing", func() {
		...
		Context("when garden project namespace is being terminated for host", func() {
			It("Should delete terminal when host namespace is terminating", func() {
				...
				By("Deleting host namespace to simulate terminating project")
				ns := &corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name: hostNamespace,
					},
		...
		Context("when garden project namespace is being terminated for target", func() {
			It("Should delete terminal when target namespace is terminating", func() {
				...
				By("Deleting target namespace to simulate terminating project")
				ns := &corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
