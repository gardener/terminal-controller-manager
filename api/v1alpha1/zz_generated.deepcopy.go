...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AllowedAPIServerServiceRef) DeepCopyInto(out *AllowedAPIServerServiceRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllowedAPIServerServiceRef.
func (in *AllowedAPIServerServiceRef) DeepCopy() *AllowedAPIServerServiceRef {
	if in == nil {
		return nil
	}
	out := new(AllowedAPIServerServiceRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ControllerManagerConfiguration) DeepCopyInto(out *ControllerManagerConfiguration) {
	*out = *in
	...
	if in.AllowedAPIServerURLs != nil {
		in, out := &in.AllowedAPIServerURLs, &out.AllowedAPIServerURLs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AllowedAPIServerServiceRefs != nil {
		in, out := &in.AllowedAPIServerServiceRefs, &out.AllowedAPIServerServiceRefs
		*out = make([]AllowedAPIServerServiceRef, len(*in))
		copy(*out, *in)
	}
