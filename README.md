...
[![CI Build status](https://github.com/gardener/terminal-controller-manager/actions/workflows/non-release.yaml/badge.svg?branch=master)](https://github.com/gardener/terminal-controller-manager/actions/workflows/non-release.yaml?query=branch%3Amaster)
